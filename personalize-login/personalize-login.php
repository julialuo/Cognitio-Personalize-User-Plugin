...
class Personalize_Login_Plugin {
    ...
    */
    function maybe_redirect_at_authenticate( $user, $username, $password ) {
        // Check if the earlier authenticate filter (most likely,ge 
    ...
    */
    private function get_error_message( $error_code ) {
        switch ( $error_code ) {
            case 'empty_username':
                return __( 'Please enter an email.', 'personalize-login' );
            ...
            case 'invalid_username':
                return __(
                    "We don't have any users with that email address. Please try again.", 'personalize-login' );
    ...
    */
    ...
    //Add recaptcha fields to general settings
